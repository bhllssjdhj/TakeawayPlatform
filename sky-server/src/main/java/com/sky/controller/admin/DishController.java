...
public class DishController {
    ...
    public Result<List<Dish>> queryAllDishByCategoryId(@RequestParam(value = "categoryId") Long cId){
        log.info("根据分类id查询菜品:{}",cId);
        List<Dish> dishes = dishService.queryAllDishByCategoryId(cId);
